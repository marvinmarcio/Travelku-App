...
class driverMapVC: UIViewController, FloatingPanelControllerDelegate {
...
//         profileImageProperties()
  ...
  //        transparentNavbar()
       ...
       appearance.backgroundColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
          ...
          guard let contentVC = storyboard?.instantiateViewController(identifier: "fpc_driver") as? DriverContentViewController else
          {
              return
          }
