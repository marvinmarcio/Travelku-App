...
class FloatingLabelInputDark: UITextField {
    ...
    @objc func addFloatingLabel() {
        if self.text == "" {
            ...
            self.floatingLabel.layer.backgroundColor = #colorLiteral(red: 0.140260458, green: 0.1452742517, blue: 0.1665444374, alpha: 1)
            self.floatingLabel.translatesAutoresizingMaskIntoConstraints = false
            self.floatingLabel.clipsToBounds = true
            self.floatingLabel.frame = CGRect(x: 0, y: 0, width: self.frame.size.width, height: self.floatingLabelHeight)
            self.floatingLabel.textColor = #colorLiteral(red: 0.9992043376, green: 0.8751468062, blue: 0.4209253788, alpha: 1)
